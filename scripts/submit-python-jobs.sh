...
LOG_FILE="compiled_adamw_unet_injflow_neuralspline_twostage_batch512_gradclip1_mnist_nottrainableq0_nstepsmse50_v1_${SCRIPT_NAME}_seed_${TRAINING_SEED}.log"
