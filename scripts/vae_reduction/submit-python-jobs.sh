...
LOG_FILE="celeba_nfon_64flows_nonorm_noimgauged_cyclicresnetvaereduction_batch1024_latentdim48_hcdim4_trainableedges_sep4and8_v1_${SCRIPT_NAME}_seed_${GPU_INDEX}.log"
LOG_FILE="celeba_alldata_cyclicbeta_noimageaug_vaeresnetreduction_batch1024_norm01_latentdim48_img128_v1_${SCRIPT_NAME}_seed_${GPU_INDEX}.log"
# LOG_FILE="encodings_celeba_noimgaug_cyclicbetawithcapacity_vaeresnetreduction_batch1024_norm01_latentdim48_img128_v1_${SCRIPT_NAME}_seed_${GPU_INDEX}.log"
