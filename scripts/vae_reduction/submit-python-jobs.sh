...
# LOG_FILE="fixedceleba_haircolor_nfon_128flows_alldata_cyclicresnetvaereduction_batch1024_latentdim48_hcdim4_nottrainableedges_sep4and8_v1_${SCRIPT_NAME}_seed_${GPU_INDEX}.log"
